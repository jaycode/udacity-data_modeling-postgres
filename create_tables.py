...
def create_database():
    ...
    conn = psycopg2.connect(dbname=config['default']['dbname'],
           user=config['default']['user'], host=config['default']['host'],
           password=config['default']['password'], port=config['default']['port'])
